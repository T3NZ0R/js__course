...
// for (let i = 0; i < 20; i++) {
//     arr[i] = Math.round(Math.random()*(732 - 8) + 7);
//     console.log(arr[i]);
// }

//2. Вивести за допомогою console.log кожен третій елемент

//let arr = [1, 2, 4, 5, 7, 10, 56, 8, 67, 36, 7, 69];
...
// let arr = ["hello", 123, true, "world", false, 979];
// let temp = [];
// let j = 0;
// for (let i = 0; i < arr.length; i++) {
...
//     for (const idKey of citiesWithId) {
//         if(usersWithId[i].id === idKey["user_id"]){
...
//             usersWithCities[i].address = idKey;
//         }
//     }
...
//             document.write(`<p><b>City</b> - ${usersList[i]["address"]["city"]}<hr/></p>`);
//             document.write(`<p><b>Street</b> - ${usersList[i]["address"]["street"]}<hr/></p>`);
//             document.write(`<p><b>Suite</b> - ${usersList[i]["address"]["suite"]}<hr/></p>`);
//             document.write(`<p><b>Zip code</b> - ${usersList[i]["address"]["zipcode"]} <hr/></p>`);
//         document.write(`</div>`);
//     document.write(`</div>`);
// }
// document.write(`</div>`);
...
for (let i = 0; i < cardsList.length; i++) {
    document.write(`<div class="post-card">`);
       document.write(`<h3>${cardsList[i]["id"]} - ${cardsList[i]["title"]}</h3> <hr/>`)
       document.write(`<p> ${cardsList[i]["body"]}</p>`)
    document.write(`</div>`);
}
document.write(`</div>`);